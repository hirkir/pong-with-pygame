...
class Ball(Block):
	def __init__(self,path,x_pos,y_pos,speed_x,speed_y,paddles):
		super().__init__(path,x_pos,y_pos)
		self.speed_x = speed_x * random.choice((-1,1)) # Ballen starter i en tilfeldig retning
	...
	def restart_counter(self):
		...
		countdown_number = 3
		# Teller ned med å bruke en timer
...
class Opponent(Block):
	...
	def constrain(self):
		# Lar ikke fienden bevege seg for langt
...
class GameManager:
	...
	def reset_ball(self):
		# Hvis ballen treffer venstre eller høyre kant resetter ballen
